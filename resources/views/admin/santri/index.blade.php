    ...
    <div class="p-6 bg-white rounded-2xl flex-1 flex flex-col">
        ...
        <div class="flex items-center justify-between mt-[65px] mb-4">
            ...
            <div class="flex items-center gap-2">
                <!-- Search -->
                <form action="{{ route('admin.santri.index') }}" method="GET" class="flex">
                    <input type="text" name="q" value="{{ request('q') }}" 
                           placeholder="Cari santri..."
                           class="border border-gray-300 rounded-lg px-3 py-2 
                                  w-80 text-1xl focus:outline-none focus:ring-2 focus:ring-primary">
                    <button type="submit" 
                            class="ml-2 px-3 py-3 bg-gray-200 rounded-lg hover:bg-gray-300">
                ...
                <a href="{{ route('admin.santri.create') }}"
                   class="bg-primary hover:bg-green-700 text-white ml-3 px-4 py-2 
                          rounded-lg text-1xl font-medium flex items-center gap-2">
                    + Tambah
                </a>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full border-collapse border-gray-300 text-sm text-left rounded-lg overflow-hidden">
                        ...
                        <td class="border px-3 py-2 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <form action="{{ route('admin.santri.destroy', $s->id) }}" 
                                    ...
                                    @method('DELETE')
                                    <button type="submit" 
                                            class="text-red-500 hover:text-red-700 mt-[5px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-7">
