...
<!-- Container Putih Utama -->
    <div class="bg-white rounded-2xl shadow-lg p-4 mx-6 relative z-40 -mt-[70px]">
        <div class="p-6 bg-white rounded-2xl">

            <!-- Header -->
            <h1 class="text-2xl font-bold flex items-center gap-2 mt-[50px] mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
                          d="M18 18.72a9.094 9.094 0 0 0 3.741-.479
                             ...
                             6.062 0 0 1 6 18.719m12 0a5.971 5.971 0
                             ...
                             5.971 0 0 0-.94 3.197M15 6.75a3 3 0
                             1 1-6 0 3 3 0 0 1 6 0Zm6 3a2.25 2.25
                             0 1 1-4.5 0 2.25 2.25 0 0 1 4.5
