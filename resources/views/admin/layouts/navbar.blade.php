...
<script>
    const pages = [
        { 
            ...
            icon: `
                <svg xmlns="http://www.w3.org/2000/svg" 
                    class="w-5 h-5 text-emerald-400 group-hover:scale-110 transition-transform" fill="none" 
                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"> <rect width="7" height="9" x="3" y="3" rx="1"/> 
        ...
        { 
            ...
            icon: `
                <svg xmlns="http://www.w3.org/2000/svg" 
                    class="w-5 h-5 {{ Request::is('admin/profile*') ? 'text-white' : 'text-emerald-400' }} 
        ...
        { 
            ...
            url: "{{ route('admin.santri.index') }}", 
                ...
                icon: `
                    <svg xmlns="http://www.w3.org/2000/svg" 
                    class="w-5 h-5 {{ Request::is('admin/santri*') ? 'text-white' : 'text-emerald-400' }} 
                    group-hover:scale-110 transition-transform" 
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        { 
            name: "Tambah Santri", 
            url: "{{ route('admin.santri.create') }}", 
            category: "Santri", 
            icon: `
                <svg xmlns="http://www.w3.org/2000/svg" 
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
                    stroke="currentColor" class="w-5 h-5 text-emerald-400 group-hover:scale-110 transition-transform">
                    <path stroke-linecap="round" stroke-linejoin="round" 
        ...
        { 
            ...
            url: "{{ route('admin.pembayaran.input') }}", 
            category: "Pembayaran", 
            icon: `
                <svg xmlns="http://www.w3.org/2000/svg" 
                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" 
                        ...
                        0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 
                        ...
                        0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 
                        1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 
                        0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 
                        3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 
                        0h.008v.008H6V10.5Z" />
                </svg>
            `
        },
            ...
            icon: `
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" 
                        ...
                        .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 
                        48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 
                        0 .414.336.75.75.75h4.5a.75.75 0 0 0 
                        .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 
                        0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 
                        1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 
                        4.01 8.25 4.973 8.25 6.108V8.25m0 
                        0H4.875c-.621 0-1.125.504-1.125 
                        1.125v11.25c0 .621.504 1.125 
                        1.125 1.125h9.75c.621 0 
                        1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 
                        12h.008v.008H6.75V12Zm0 
                        3h.008v.008H6.75V15Zm0 
        ...
        if (input.trim() === "") {
            resultsDiv.innerHTML = `
                <div class='px-4 py-3 text-gray-500 text-sm border-b bg-gray-50'>
                    💡 <span class="font-semibold">Tips:</span> Ketik untuk mencari halaman admin
                </div>
            `;
