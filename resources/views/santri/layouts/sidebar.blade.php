        ...
        <ul class="space-y-0">
            ...
            <li>
                <a href="{{ route('santri.pembayaran.index') }}"
                    ...
                    <span class="tracking-wide">PEMBAYARAN SPP</span>
                </a>
            </li>

            <li>
                <a href="{{ route('santri.kwitansi.index') }}"
                    class="flex items-center gap-3 px-5 py-3.5 font-bold text-[14.5px] transition-all duration-200 group relative
                    ...
                    <span class="tracking-wide">KWITANSI PEMBAYARAN</span>
                </a>
            </li>
        </ul>
    </nav>
